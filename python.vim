...
syntax  keyword  pythonType         bool bytearray bytes classmethod complex deque defaultdict dict enumerate filter float frozenset property int list map memoryview object range reversed set slice staticmethod str super tuple type zip
